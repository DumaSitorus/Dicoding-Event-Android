...
import com.duma.dicodingevent.databinding.FinishedItemBinding
...
class FinishedEventAdapter: ListAdapter<ListEventsItem, FinishedEventAdapter.MyViewHolder>(DIFF_CALLBACK) {
    ...
    inner class MyViewHolder(private val binding: FinishedItemBinding) : RecyclerView.ViewHolder(binding.root) {
        init {
