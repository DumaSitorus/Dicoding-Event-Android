...
import com.duma.dicodingevent.databinding.UpcomingItemBinding
...
class UpcomingEventAdapter: ListAdapter<ListEventsItem, UpcomingEventAdapter.MyViewHolder>(DIFF_CALLBACK) {
    ...
    inner class MyViewHolder(private val binding: UpcomingItemBinding) : RecyclerView.ViewHolder(binding.root) {
        init {
